...
```{r, QR_code, fig.cap="Coverpage of the supplementary survey", warning=FALSE, fig.height=13, echo=FALSE, message=FALSE}
...
```{r, Survey, fig.cap="Screenshots of the supplementary survey", warning=FALSE, echo=FALSE, message=FALSE}
