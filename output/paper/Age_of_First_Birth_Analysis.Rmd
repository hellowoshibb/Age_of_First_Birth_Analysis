...
gss_fl <- gss%>% # Original dataset cleaning
...
gss_fl_test <- gss_fl %>% # Ivan testing dataset cleaning
  select(mean_age, feelings_life, age_at_first_birth) %>%
  group_by(age_at_first_birth) %>%
  mutate(round_age = round(age_at_first_birth))
  
 gss_fl_testa <- gss_fl_test %>% # Ivan testing dataset cleaning
  select(mean_age, round_age, feelings_life, age_at_first_birth) %>%
  group_by(round_age) %>%
  mutate(mean_feeling = mean(feelings_life))

gss_fl_testa %>% # Ivan's graph
